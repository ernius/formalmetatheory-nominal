...
\\
\>\AgdaFunction{lemma∼αfv} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{=} \AgdaFunction{lemmaΛItStrongαCompatible} \AgdaSymbol{(}\AgdaDatatype{List} \AgdaFunction{Atom}\AgdaSymbol{)} \AgdaFunction{[\_]} \AgdaFunction{\_++\_} \AgdaInductiveConstructor{[]} \AgdaSymbol{(λ} \AgdaBound{v} \AgdaBound{r} \AgdaSymbol{→} \AgdaBound{r} \AgdaFunction{-} \AgdaBound{v}\AgdaSymbol{)} \AgdaBound{M} \AgdaBound{N} \<%
\end{code}
...
\begin{code}%
\>\AgdaFunction{free} \AgdaSymbol{:} \AgdaFunction{Atom} \AgdaSymbol{→} \AgdaDatatype{Λ} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\<%
\\
\>\AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{=} \AgdaFunction{ΛIt} \AgdaPrimitiveType{Set} \AgdaSymbol{(λ} \AgdaBound{b} \AgdaSymbol{→} \AgdaBound{a} \AgdaDatatype{≡} \AgdaBound{b}\AgdaSymbol{)} \AgdaDatatype{\_∨\_} \AgdaSymbol{(}\AgdaFunction{[} \AgdaBound{a} \AgdaFunction{]} \AgdaInductiveConstructor{,} \AgdaFunction{const} \AgdaFunction{id}\AgdaSymbol{)} \<[54]%
\>[54]\<%
\\
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{freeλ} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaBound{a} \AgdaBound{b} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M}\AgdaSymbol{)} \AgdaDatatype{≡} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaFunction{χ} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{]} \AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
...
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{freeStrongCompatible} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{strong∼αCompatible} \AgdaSymbol{(}\AgdaFunction{free} \AgdaBound{a}\AgdaSymbol{)} \AgdaBound{M}\<%
\\
...
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemmavfree} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{b}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{a} \AgdaDatatype{≡} \AgdaBound{b} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{b}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{lemmavfree} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{.\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaInductiveConstructor{refl} \<[26]%
\>[26]\AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemma·rfree} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{M}\AgdaSymbol{\}} \AgdaBound{N} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaBound{M} \AgdaInductiveConstructor{·} \AgdaBound{N}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{lemma·rfree} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaBound{N} \AgdaBound{afreeM} \AgdaSymbol{=} \AgdaInductiveConstructor{inj₁} \AgdaBound{afreeM}\<%
\\
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemma·lfree} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaBound{M} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{N} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaBound{M} \AgdaInductiveConstructor{·} \AgdaBound{N}\AgdaSymbol{)}\<%
\\
\>\AgdaFunction{lemma·lfree} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaBound{M} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaBound{afreeN} \AgdaSymbol{=} \AgdaInductiveConstructor{inj₂} \AgdaBound{afreeN}\<%
\\
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{Pfs} \AgdaSymbol{:} \AgdaFunction{Atom} \AgdaSymbol{→} \AgdaDatatype{Λ} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\<%
\\
\>\AgdaFunction{Pfs} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{=} \AgdaSymbol{∀} \AgdaBound{b} \AgdaBound{c} \AgdaSymbol{→} \AgdaBound{a} \AgdaFunction{≢} \AgdaBound{b} \AgdaSymbol{→} \AgdaBound{a} \AgdaFunction{≢} \AgdaBound{c} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{c} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
\>\AgdaComment{--}\<%
\\
...
\>[14]\AgdaFunction{free} \AgdaBound{a} \AgdaBound{M}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{afree（bc）M} \AgdaSymbol{:} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{c} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{afree（（bc）df）（bc）M} \AgdaSymbol{:} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{（} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{c} \AgdaFunction{）ₐ} \AgdaBound{d} \AgdaFunction{∙} \AgdaBound{f} \AgdaFunction{）} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{c} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemmaƛfree} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{b} \AgdaBound{a} \AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{a} \AgdaFunction{≢} \AgdaBound{b} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
...
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemma*→free} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{a} \AgdaDatatype{*} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M}\<%
\\
...
\\
\>\AgdaFunction{Pfs2} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{=} \AgdaSymbol{∀} \AgdaBound{b} \AgdaBound{c} \AgdaSymbol{→} \AgdaBound{a} \AgdaFunction{≢} \AgdaBound{b} \AgdaSymbol{→} \AgdaBound{a} \AgdaFunction{≢} \AgdaBound{c} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{c} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M}\<%
\\
\>\AgdaComment{--}\<%
\\
...
\\
\>\AgdaFunction{Pf*} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{=} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{a} \AgdaDatatype{*} \AgdaBound{M}\<%
\\
\>\AgdaComment{--}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{=} \AgdaFunction{TermαIndPerm} \AgdaSymbol{(}\AgdaFunction{Pf*} \AgdaBound{a}\AgdaSymbol{)} \AgdaFunction{αCompatiblePf*a} \AgdaSymbol{(λ} \AgdaSymbol{\{}\AgdaSymbol{.}\AgdaBound{a} \AgdaInductiveConstructor{refl} \AgdaSymbol{→} \AgdaInductiveConstructor{*v}\AgdaSymbol{\})} \AgdaFunction{lemma·} \AgdaSymbol{(}\AgdaFunction{[} \AgdaBound{a} \AgdaFunction{]} \AgdaInductiveConstructor{,} \AgdaFunction{lemmaƛ}\AgdaSymbol{)} \AgdaBound{M}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{where}\<%
\\
...
\\
\>[2]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{→} \AgdaSymbol{((}\AgdaBound{π} \AgdaSymbol{:} \AgdaDatatype{List} \AgdaSymbol{(}\AgdaFunction{Atom} \AgdaFunction{×} \AgdaFunction{Atom}\AgdaSymbol{))} \AgdaSymbol{→} \AgdaFunction{Pf*} \AgdaBound{a} \AgdaSymbol{(}\AgdaBound{π} \AgdaFunction{∙} \AgdaBound{M}\AgdaSymbol{))} \<[54]%
\>[54]\<%
\\
\>[2]\AgdaIndent{9}{}\<[9]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{...} \AgdaSymbol{|} \AgdaBound{c} \AgdaSymbol{|} \AgdaBound{c∉[a]} \AgdaSymbol{=} \AgdaInductiveConstructor{*ƛ} \AgdaSymbol{(}\AgdaFunction{lemma*swap←≢} \AgdaSymbol{(}\AgdaFunction{sym≢} \AgdaFunction{b≢a}\AgdaSymbol{)} \AgdaFunction{a≢c} \AgdaSymbol{(}\AgdaBound{Hi} \AgdaFunction{[}\AgdaSymbol{(} \AgdaBound{b} \AgdaInductiveConstructor{,} \AgdaBound{c}\AgdaSymbol{)}\AgdaFunction{]} \AgdaBound{afree（bc）M}\AgdaSymbol{))} \AgdaFunction{b≢a}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaKeyword{where} \<[10]%
\>[10]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{b≢a} \AgdaSymbol{=} \AgdaSymbol{λ} \AgdaBound{b≡a} \AgdaSymbol{→} \AgdaBound{b∉[a]} \AgdaSymbol{(}\AgdaInductiveConstructor{here} \AgdaBound{b≡a}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>\AgdaFunction{Pfvf} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{=} \AgdaBound{a} \AgdaFunction{∈} \AgdaFunction{fv} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{free} \AgdaBound{a} \AgdaBound{M}\<%
\\
\>\AgdaComment{--}\<%
\\
...
\>\AgdaComment{--}\<%
\\
\>\AgdaFunction{lemmafvf} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaBound{M}\<%
\\
\>\AgdaFunction{lemmafvf} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \<[17]%
\>[17]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{=} \AgdaFunction{TermαIndPerm} \AgdaSymbol{(}\AgdaFunction{Pfvf} \AgdaBound{a}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{αCompatiblePfvfa} \AgdaBound{a}\AgdaSymbol{)} \AgdaFunction{lemmav} \AgdaFunction{lemma·} \AgdaSymbol{(}\AgdaFunction{[} \AgdaBound{a} \AgdaFunction{]} \AgdaInductiveConstructor{,} \AgdaFunction{lemmaƛ}\AgdaSymbol{)} \AgdaBound{M} \<[82]%
\>[82]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{where}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{b} \AgdaSymbol{:} \AgdaDatatype{ℕ}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{b}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaSymbol{.}\AgdaBound{a} \<[13]%
\>[13]\AgdaSymbol{(}\AgdaInductiveConstructor{here} \AgdaInductiveConstructor{refl}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaInductiveConstructor{refl}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaSymbol{\_} \<[13]%
\>[13]\AgdaSymbol{(}\AgdaInductiveConstructor{there} \AgdaSymbol{())}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemma·} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{M} \AgdaBound{N} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaBound{N} \AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaSymbol{(}\AgdaBound{M} \AgdaInductiveConstructor{·} \AgdaBound{N}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemma·} \AgdaBound{M} \AgdaBound{N} \AgdaBound{PfvfaM} \AgdaBound{PfvfaN} \AgdaBound{a∈fvM++fvN} \AgdaKeyword{with} \AgdaFunction{c∈xs++ys→c∈xs∨c∈ys} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{fv} \AgdaBound{M}\AgdaSymbol{\}} \AgdaBound{a∈fvM++fvN} \<[84]%
\>[84]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{inj₁} \AgdaBound{a∈fvM} \AgdaSymbol{=} \AgdaInductiveConstructor{inj₁} \AgdaSymbol{(}\AgdaBound{PfvfaM} \AgdaBound{a∈fvM}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{inj₂} \AgdaBound{a∈fvN} \AgdaSymbol{=} \AgdaInductiveConstructor{inj₂} \AgdaSymbol{(}\AgdaBound{PfvfaN} \AgdaBound{a∈fvN}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmaƛ} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{M} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{b} \AgdaSymbol{:} \AgdaDatatype{ℕ}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaBound{b} \AgdaFunction{∉} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{]} \<[39]%
\>[39]\<%
\\
\>[2]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{→} \AgdaSymbol{((}\AgdaBound{π} \AgdaSymbol{:} \AgdaDatatype{List} \AgdaSymbol{(}\AgdaFunction{Atom} \AgdaFunction{×} \AgdaFunction{Atom}\AgdaSymbol{))} \<[37]%
\>[37]\<%
\\
\>[2]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaSymbol{(}\AgdaBound{π} \AgdaFunction{∙} \AgdaBound{M}\AgdaSymbol{))} \<[27]%
\>[27]\<%
\\
\>[2]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{→} \AgdaFunction{Pfvf} \AgdaBound{a} \AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{=} \AgdaFunction{lemmaƛfree} \AgdaSymbol{\{}\AgdaBound{b}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{lemmaFreeSwap2} \AgdaBound{M} \AgdaBound{a} \AgdaBound{b} \AgdaBound{c} \AgdaFunction{a≢b} \AgdaBound{a≢c} \AgdaSymbol{(}\AgdaBound{f} \AgdaFunction{[}\AgdaSymbol{(}\AgdaBound{b} \AgdaInductiveConstructor{,} \AgdaBound{c}\AgdaSymbol{)}\AgdaFunction{]} \AgdaBound{a∈fv（bc）M}\AgdaSymbol{))} \AgdaFunction{a≢b} \<[90]%
\>[90]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaKeyword{where}\<%
