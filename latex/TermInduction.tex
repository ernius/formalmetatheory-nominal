...
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \<[5]%
\>[5]\AgdaSymbol{(∀} \AgdaBound{M} \AgdaBound{b} \AgdaSymbol{→} \AgdaBound{b} \AgdaFunction{∉'} \AgdaBound{vs} \AgdaSymbol{→} \AgdaBound{P} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{P} \AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M}\AgdaSymbol{))} \<[41]%
\>[41]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \<[5]%
...
\>[16]\AgdaSymbol{(}\AgdaBound{P} \AgdaSymbol{:} \AgdaDatatype{Λ} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{αCompatiblePred} \AgdaBound{P} \<[50]%
\>[50]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \AgdaSymbol{(∀} \AgdaBound{a} \AgdaSymbol{→} \AgdaBound{P} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{a}\AgdaSymbol{))}\<%
...
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaSymbol{→} \<[5]%
\>[5]\AgdaSymbol{(∀} \AgdaBound{M} \AgdaBound{b} \AgdaSymbol{→} \AgdaBound{b} \AgdaFunction{∉'} \AgdaBound{vs} \AgdaSymbol{→} \AgdaSymbol{(∀} \AgdaBound{π} \AgdaSymbol{→} \<[32]%
