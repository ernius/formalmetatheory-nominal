...
\>[22]\AgdaKeyword{with} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{d}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{c} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]} \AgdaSymbol{|} \AgdaFunction{lemmahvar} \AgdaSymbol{\{}\AgdaBound{c}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{d}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \<[68]%
\>[68]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaFunction{≈⟨} \AgdaFunction{cong} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaFunction{（} \AgdaFunction{f} \AgdaFunction{∙} \AgdaBound{g} \AgdaFunction{）} \AgdaFunction{（} \AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）ₐ} \AgdaBound{d} \AgdaFunction{∙} \AgdaFunction{f} \AgdaFunction{）} \AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaFunction{（} \AgdaFunction{f} \AgdaFunction{∙} \AgdaBound{g} \AgdaFunction{）} \AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{)} \AgdaSymbol{(} \AgdaFunction{sym} \AgdaSymbol{(}\AgdaFunction{lemma∙ₐc≢a∧c≢b} \AgdaSymbol{(}\AgdaFunction{sym≢} \AgdaFunction{f≢（ab）c}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{sym≢} \AgdaSymbol{(}\AgdaFunction{g≢（ab）c} \AgdaBound{g∉vs}\AgdaSymbol{))))} \<[163]%
\>[163]\AgdaFunction{⟩}\<%
\\
\>[9]\AgdaIndent{12}{}\<[12]%
...
\begin{code}%
\>\AgdaFunction{lemmaƛ∼[]} \AgdaSymbol{:} \AgdaSymbol{∀} \AgdaSymbol{\{}\AgdaBound{a} \AgdaBound{b} \AgdaBound{P}\AgdaSymbol{\}} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{b} \AgdaFunction{∉} \AgdaBound{a} \AgdaInductiveConstructor{∷} \AgdaFunction{fv} \AgdaBound{P} \AgdaSymbol{→} \AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaBound{P} \AgdaFunction{]} \AgdaDatatype{∼α} \<[62]%
\>[62]\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaBound{P} \AgdaFunction{]}\AgdaSymbol{)}\<%
\\
...
\\
\>[12]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaFunction{c} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaBound{P} \AgdaFunction{]} \<[60]%
\>[60]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\>[63]\AgdaBound{a} \AgdaFunction{:=} \AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]} \<[82]%
\>[82]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）ₐ} \AgdaBound{a} \AgdaFunction{:=} \AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]} \<[71]%
\>[71]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
\>[23]\AgdaFunction{≈⟨} \AgdaFunction{cong} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{lemma∙ₐc≢a∧c≢b} \AgdaFunction{a≢c} \AgdaSymbol{(}\AgdaFunction{a≢d} \AgdaBound{d∉}\AgdaSymbol{))} \AgdaFunction{⟩} \<[107]%
\>[107]\<%
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaFunction{（} \AgdaFunction{c} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]} \<[60]%
\>[60]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaBound{P} \AgdaFunction{]} \<[50]%
\>[50]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]} \<[60]%
\>[60]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
\>[23]\AgdaFunction{≈⟨} \AgdaFunction{sym} \AgdaSymbol{(}\AgdaFunction{cong} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaFunction{lemma∙ₐc≢a∧c≢b} \AgdaFunction{a≢b} \AgdaSymbol{(}\AgdaFunction{a≢d} \AgdaBound{d∉}\AgdaSymbol{)))} \AgdaFunction{⟩} \<[113]%
\>[113]\<%
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaSymbol{(}\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{M}\AgdaSymbol{)} \AgdaFunction{[} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）ₐ} \AgdaBound{a} \AgdaFunction{:=} \AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaBound{P} \AgdaFunction{]} \<[71]%
\>[71]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\\
\>[23]\AgdaIndent{25}{}\<[25]%
\>[25]\AgdaFunction{（} \AgdaBound{b} \AgdaFunction{∙} \AgdaBound{d} \AgdaFunction{）} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{a} \AgdaFunction{:=} \AgdaBound{P} \AgdaFunction{]}\AgdaSymbol{)} \<[50]%
\>[50]\<%
\\
\>[0]\AgdaIndent{23}{}\<[23]%
...
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]} \<[24]%
\>[24]\<%
\\
\>[0]\AgdaIndent{5}{}\<[5]%
...
\\
\>[2]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{P} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \<[33]%
\>[33]\<%
\\
\>[0]\AgdaIndent{5}{}\<[5]%
...
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \<[33]%
\>[33]\<%
\\
\>[0]\AgdaIndent{5}{}\<[5]%
...
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]} \<[44]%
\>[44]\<%
\\
\>[0]\AgdaIndent{5}{}\<[5]%
...
\\
\>[5]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaSymbol{(}\AgdaBound{P} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]} \<[44]%
\>[44]\<%
\\
\>[0]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaFunction{∎}\<%
...
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaSymbol{.(}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \<[23]%
\>[23]\AgdaSymbol{|} \AgdaInductiveConstructor{inj₁} \AgdaSymbol{(\_} \<[36]%
\>[36]\AgdaInductiveConstructor{,} \AgdaInductiveConstructor{refl}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{ρ}\<%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{with} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{a}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]} \AgdaSymbol{|} \AgdaFunction{lemmahvar} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{\}} \<[71]%
\>[71]\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaSymbol{.(}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \<[23]%
\>[23]\AgdaSymbol{|} \AgdaInductiveConstructor{inj₁} \AgdaSymbol{(}\AgdaBound{x≡a} \<[38]%
\>[38]\AgdaInductiveConstructor{,} \AgdaInductiveConstructor{refl}\AgdaSymbol{)} \<[47]%
\>[47]\AgdaSymbol{=} \AgdaFunction{⊥-elim} \AgdaSymbol{(}\AgdaBound{x≢a} \AgdaBound{x≡a}\AgdaSymbol{)}\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaSymbol{.(}\AgdaInductiveConstructor{v} \AgdaBound{a}\AgdaSymbol{)} \<[23]%
...
\\
\>[2]\AgdaIndent{18}{}\<[18]%
\>[18]\AgdaSymbol{(}\AgdaBound{y} \AgdaInductiveConstructor{∷} \AgdaFunction{fv} \AgdaBound{L} \AgdaFunction{++} \AgdaBound{x} \AgdaInductiveConstructor{∷} \AgdaFunction{fv} \AgdaBound{N} \AgdaFunction{++} \AgdaFunction{fv} \AgdaSymbol{(}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \AgdaInductiveConstructor{,} \AgdaFunction{lemmaƛ}\AgdaSymbol{)} \<[71]%
\>[71]\<%
\\
\>[2]\AgdaIndent{18}{}\<[18]%
\>[18]\AgdaBound{M} \<[20]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmaƛ} \AgdaBound{M} \AgdaBound{b} \AgdaBound{b∉} \AgdaBound{PM} \AgdaBound{x≢y} \AgdaBound{x∉fvL} \<[29]%
\>[29]\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{=} \<[7]%
...
\\
\>[4]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{)} \<[30]%
\>[30]\AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
...
\\
\>[7]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaSymbol{((}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{]}\AgdaSymbol{)} \<[30]%
\>[30]\AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaFunction{∼⟨} \AgdaFunction{lemma∼αƛ} \AgdaSymbol{(}\AgdaBound{PM} \AgdaBound{x≢y} \AgdaBound{x∉fvL}\AgdaSymbol{)} \AgdaFunction{⟩} \<[36]%
\>[36]\<%
\\
\>[7]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaSymbol{((}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \<[30]%
\>[30]\AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaFunction{∼⟨} \AgdaFunction{σ} \AgdaSymbol{(}\AgdaFunction{lemmaƛ∼[]} \AgdaSymbol{(}\AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \AgdaFunction{b∉x∷fvN[y:=L]}\AgdaSymbol{)} \AgdaFunction{⟩} \<[55]%
\>[55]\<%
\\
\>[7]\AgdaIndent{9}{}\<[9]%
...
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaFunction{≈⟨} \AgdaFunction{sym} \AgdaSymbol{(}\AgdaFunction{lemmaSubst1} \AgdaSymbol{(}\AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \<[43]%
\>[43]\AgdaBound{x} \AgdaSymbol{(}\AgdaFunction{lemmaƛ∼[]} \AgdaBound{M} \AgdaFunction{b∉y∷fvL}\AgdaSymbol{))} \<[69]%
\>[69]\AgdaFunction{⟩}\<%
\\
\>[7]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{(}\AgdaInductiveConstructor{ƛ} \AgdaBound{b} \AgdaBound{M} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]}\AgdaSymbol{)} \<[30]%
\>[30]\AgdaFunction{[} \AgdaBound{x} \AgdaFunction{:=} \AgdaBound{N} \AgdaFunction{[} \AgdaBound{y} \AgdaFunction{:=} \AgdaBound{L} \AgdaFunction{]} \AgdaFunction{]}\<%
\\
\>[0]\AgdaIndent{7}{}\<[7]%
\>[7]\AgdaFunction{∎}\<%
\\
